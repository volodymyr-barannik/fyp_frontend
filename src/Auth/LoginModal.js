            ...
            return (
                <div className="modal-backdrop" onClick={handleClose}>
                    <div className="modal" onClick={(e) => e.stopPropagation()}>
                        <h2 style={{'fontSize': '40px', 'margin': '0px'}}>Log In</h2>
                        <div className="flex-box-align-left" style={{'gap': '2px', 'width': 'auto', 'marginTop': '15px'}}>
                        ...
                        <form style={{'marginTop': '30px'}}>
                            ...
                            <div></div>
                            <div className="center-contents" style={{'marginTop': '30px'}}>
                ...
                <div className="modal-backdrop" onClick={handleClose}>
                    <div className="modal" onClick={(e) => e.stopPropagation()}
                        ...
                        <form style={{'marginTop': '30px'}}>
                            ...
                            <div style={{'marginTop': '30px'}}>Mail</div>
